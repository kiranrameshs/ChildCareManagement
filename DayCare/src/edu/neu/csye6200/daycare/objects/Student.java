...
public class Student extends Person {
	...
	public Student(String firstName, String lastName, int age, String address, String fatherName, String motherName,String phoneNumber, Date dateOfJoining,int studentID, Date dateOfBirth) {
