...
public class StudentFactory {
	...
	public  List<Student> initWithAllDetailsStudentObj (List<String> data) throws ParseException {
		...
		public  List<Student> initStudentObj (List<String> data) throws ParseException {
			...
			Iterator<String> it = data.iterator();
				while(it.hasNext()) {
					...
					String phoneNumber          =eachLine[7];
					String dateOfJoining          =eachLine[8];
					//studentList.add(new Student( studentID, firstName,  lastName,  age,  address,  fatherName,  motherName, phoneNumber, dateFormat.parse(dateOfJoining)));
					studentList.add(new Student( studentID, firstName,  lastName,  age,  address,  fatherName,  motherName, phoneNumber, sdf.parse(dateOfJoining)));
						} 
				return studentList;
		}
